...
PreparedStatement pt;
    ...
    modelo.setRowCount(0);
         ...
         try {
              cone=getConnection();
              pt=cone.prepareStatement("SELECT `id_usuario`, `nombre_usu`, `cargo`, `contraseña` FROM `usuario`");
    ...
    String dato = txtbuscarempleo.getText();
         try {
              ...
              cone=getConnection();
              pt=cone.prepareStatement("SELECT `id_usuario`, `nombre_usu`, `cargo`, `contraseña` FROM `usuario` WHERE `id_usuario`='"+dato+"' ");
         ResultSet rs = pt.executeQuery();
              rsmd=rs.getMetaData();
              columna=rsmd.getColumnCount();
...
return ver;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de usuario");
    ...
    private void tablaempleadosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaempleadosMouseClicked
        ...
        try {
            ...
            con=getConnection();
            pt=con.prepareStatement("SELECT `id_usuario`, `nombre_usu`, `cargo`, `contraseña` FROM `usuario` WHERE `id_usuario`=?");
            pt.setInt(1, id);
            ResultSet rs = pt.executeQuery();
            while(rs.next()){
                txtCedula.setText(String.valueOf(id));
                txtNombre.setText(rs.getString("nombre"));
                txtApellido.setText(rs.getString("cargo"));
                txtDireccion.setText(rs.getString("contraseña"));
    ...
    private void btnbuscarproveedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarproveedorActionPerformed
        ...
        try {
            cone = getConnection();
            pt=cone.prepareStatement("SELECT * FROM `usuario` WHERE `id_usuario`=?");
    ...
    if (confirmacion ==JOptionPane.YES_OPTION){
         ...
         try {
            con=getConnection();
            pt=con.prepareStatement("DELETE FROM `usuario` WHERE `id_usuario`= ?");
    ...
    private void jButton2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton2MouseClicked
        // TODO add your handling code here:
         this.hide();
        RegistroUsuario empleo = new RegistroUsuario();
